...
package com.transaksi.TabelHeaderCheckBox;
 ...
 * @author krypton
 */
public class TabelHeaderCheckBox implements TableCellRenderer{
    
    private final JCheckBox check=new JCheckBox();
    
    public TabelHeaderCheckBox(JTableHeader header, final int index){
